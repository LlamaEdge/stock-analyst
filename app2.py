...
from widgets import get_tradingview_widget, get_company_news, get_stock_data
...
def update_summary(new_summary):
    st.session_state.current_system_message = f"Use this SEC filing summary in your response: {new_summary}"
        ...
        for filing in filings:
            ...
            with st.sidebar.expander(filing_label):
                ...
                if st.button("Use This Summary", key=f"select_{filing['accession_number']}"):
                    ...
                    st.success("Summary selected! Future responses will be informed by this summary.")
